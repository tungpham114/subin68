...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 15, 2025 lúc 12:42 PM
...
INSERT INTO `services` (`id`, `user_id`, `title`, `description`, `price`, `image`, `created_at`, `brand`) VALUES
(1, 2, 'Thêu tay hoa văn truyền thống', 'Dịch vụ thêu tay các hoa văn truyền thống trên vải lụa, phù hợp làm quà tặng.', 500000, 'uploads/do-gom1.jpg', '2025-05-09 19:00:00', 'Thương hiệu A'),
(2, 2, 'Khắc gỗ thủ công', 'Khắc các hình ảnh, chữ viết lên gỗ theo yêu cầu, đảm bảo tinh xảo.', 300000, 'uploads/khac-go1.jpg', '2025-05-10 21:00:00', 'Thương hiệu B'),
(3, 3, 'Đan giỏ mây tre', 'Đan giỏ mây tre thủ công, bền đẹp, thân thiện với môi trường.', 200000, 'gio-may-tre.jpg', '2025-05-11 23:00:00', 'Thương hiệu A'),
(4, 3, 'Làm đồ gốm trang trí', 'Tạo các sản phẩm gốm trang trí như bình hoa, chén nhỏ với họa tiết độc đáo.', 400000, 'do-gom.jpg', '2025-05-13 01:00:00', 'Thương hiệu B'),
(5, 2, 'May váy truyền thống', 'May váy áo dài truyền thống với chất liệu lụa cao cấp.', 800000, 'ao-dai.jpg', '2025-05-14 03:00:00', 'Chưa có');
